module Presentations.TeachingAMachineToCode2019 exposing (main)
...
slides =
    ...
    , [ h1 [] [ text "What does it mean to be human?" ] ]
        ...
        ++ [ [ table []
           ...
           , [ p [] [ text "Introducing Codename: Snoopy." ]
             , p [] [ img [ src "https://assets.noodlesandwich.com/talks/teaching-a-machine-to-code/snoopy.png" ] [] ]
             ]
           , [ h1 [] [ text "The Present" ]
             , div []
                [ p []
                    [ text "Seeing one thing at a time"
                    , br [] []
                    , hidden <| text "Seeing everything at once"
                    ]
                , p []
                    [ text "Debugging your code"
                    , br [] []
                    , hidden <| text "A complete history of your state transitions"
                    ]
                , p []
                    [ text "Mining commits to understand how data got that way"
                    , br [] []
                    , hidden <| text "Event sourcing by default"
                    ]
                , p []
                    [ text "Writing UI tests"
                    , br [] []
                    , hidden <| text "Generating tests from activity"
                    ]
                , p []
                    [ text "Waiting weeks to find out if it works"
                    , br [] []
                    , hidden <| text "Instant feedback"
                    ]
                ]
             ]
           , [ h1 [] [ text "The Future" ]
             , div []
                [ p []
                    [ del [] [ text "Seeing one thing at a time" ]
                    , br [] []
                    , ins [] [ text "Seeing everything at once" ]
                    ]
                , p []
                    [ del [] [ text "Debugging your code" ]
                    , br [] []
                    , ins [] [ text "A complete history of your state transitions" ]
                    ]
                , p []
                    [ del [] [ text "Mining commits to understand how data got that way" ]
                    , br [] []
                    , ins [] [ text "Event sourcing by default" ]
                    ]
                , p []
                    [ del [] [ text "Writing UI tests" ]
                    , br [] []
                    , ins [] [ text "Generating tests from activity" ]
                    ]
                , p []
                    [ del [] [ text "Waiting weeks to find out if it works" ]
                    , br [] []
                    , ins [] [ text "Instant feedback" ]
                    ]
                ]
             ]
           , [ h1 [] [ text "Just one thing." ]
             , hidden <| p [] [ text "I need you to write high-quality code." ]
             ]
           , [ h1 [] [ text "Just one thing." ]
             , p [] [ text "I need you to write high-quality code." ]
             ]
           , [ h1 [] [ text "You are important." ] ]
           , [ h1 [] [ text "What's Next?" ]
             , div []
                [ p []
